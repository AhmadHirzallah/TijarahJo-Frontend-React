  ...
  const validateForm = () => {
    ...
    if (!jordanPhoneRegex.test(cleanedPhone)) {
      newErrors.phoneNumber =
        "Enter a valid Jordan mobile number (077, 078, or 079).";
    }
    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 py-12 px-4">
      <div className="max-w-xl w-full space-y-8 bg-white p-12 rounded-[3.5rem] shadow-[0_40px_100px_-20px_rgba(0,0,0,0.1)] border border-slate-100">
        <div className="text-center">
          ...
          <h2 className="mt-8 text-4xl font-black text-slate-900 tracking-tighter">
            Create Account
          </h2>
          <p className="mt-3 text-slate-500 font-bold uppercase text-[10px] tracking-[0.3em]">
            Join Jordan's Elite Marketplace
          </p>
        </div>
