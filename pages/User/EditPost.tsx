...
import { ShoppingBag, Image as ImageIcon, Save, AlertCircle, Upload, X } from 'lucide-react';
      ...
      <div className="bg-white rounded-[2.5rem] shadow-xl overflow-hidden border">
        <div className="bg-indigo-600 p-8 text-white flex items-center justify-between">
          <div>
            ...
            <p className="text-indigo-100 mt-1">Update your item details</p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-8 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-gray-50 rounded-3xl p-6 flex flex-col justify-center text-center space-y-4">
                <ImageIcon className="mx-auto text-gray-300" size={64} />
                <p className="text-gray-500 font-medium">To manage photos, please visit the listing details page after updating the text information.</p>
            </div>
          </div>

          <div className="pt-8 border-t flex items-center justify-end gap-4">
             <button type="button" onClick={() => navigate('/my-posts')} className="px-8 py-3 rounded-full font-bold text-gray-500 hover:bg-gray-100 transition-all">
               Cancel
             </button>
             <button
               type="submit"
               disabled={saving}
               className="bg-indigo-600 text-white px-12 py-3 rounded-full font-bold text-lg hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-200 disabled:opacity-50"
             >
